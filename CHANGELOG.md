...
Bumps the docker group with 1 update in the / directory: playwright/python.
...
Updates `playwright` from 1.46.0 to 1.47.0 - [Release
...
--- updated-dependencies: - dependency-name: playwright dependency-type: direct:production
...
Updates `playwright` from 1.47.0 to 1.48.0 - [Release
  notes](https://github.com/Microsoft/playwright-python/releases) -
  [Commits](https://github.com/Microsoft/playwright-python/compare/v1.47.0...v1.48.0)

Updates `python-semantic-release` from 9.9.0 to 9.12.0 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
  [Commits](https://github.com/python-semantic-release/python-semantic-release/compare/v9.9...v9.12)
...
Bumps the python-packages group with 2 updates: [pipdeptree](https://github.com/tox-dev/pipdeptree)
  and [pylint](https://github.com/pylint-dev/pylint).

Updates `pipdeptree` from 2.23.3 to 2.23.4 - [Release
  notes](https://github.com/tox-dev/pipdeptree/releases) -
  [Commits](https://github.com/tox-dev/pipdeptree/compare/2.23.3...2.23.4)

Updates `pylint` from 3.2.7 to 3.3.0 - [Release
  notes](https://github.com/pylint-dev/pylint/releases) -
...
Updates `python-semantic-release` from 9.8.8 to 9.9.0 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
  [Commits](https://github.com/python-semantic-release/python-semantic-release/compare/v9.8.8...v9.9)

Updates `pylint` from 3.3.0 to 3.3.1 - [Release
  notes](https://github.com/pylint-dev/pylint/releases) -
...
Updates `python-semantic-release/python-semantic-release` from 9.8.8 to 9.9.0 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
...
Updates `python-semantic-release/python-semantic-release` from 9.9.0 to 9.10.0 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
...
Updates `docker/scout-action` from 1.15.0 to 1.15.1 - [Release
  notes](https://github.com/docker/scout-action/releases) -
...
Updates `pipdeptree` from 2.23.0 to 2.23.1 - [Release
  notes](https://github.com/tox-dev/pipdeptree/releases) -
...
Updates `playwright` from 1.45.0 to 1.45.1 - [Release
  notes](https://github.com/Microsoft/playwright-python/releases) -
...
Updates `playwright` from 1.45.1 to 1.46.0 - [Release
  notes](https://github.com/Microsoft/playwright-python/releases) -
...
Updates `python-semantic-release` from 9.8.5 to 9.8.6 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
  [Commits](https://github.com/python-semantic-release/python-semantic-release/compare/v9.8.5...v9.8.6)

Updates `pylint` from 3.2.5 to 3.2.6 - [Release
  notes](https://github.com/pylint-dev/pylint/releases) -
...
Bumps the python-packages group with 3 updates: [pygithub](https://github.com/pygithub/pygithub),
  [python-semantic-release](https://github.com/python-semantic-release/python-semantic-release) and
...
Updates `pytest-asyncio` from 0.23.8 to 0.24.0 - [Release
...
Updates `docker/scout-action` from 1.11.0 to 1.13.0 - [Release
  notes](https://github.com/docker/scout-action/releases) -
...
- Bump python-semantic-release/python-semantic-release
  ([#10](https://github.com/Nicconike/Steam-Stats/pull/10),
  [`ebbe02e`](https://github.com/Nicconike/Steam-Stats/commit/ebbe02ea9401f63aec54a2e37381bd7f6961b9b2))

Bumps the github-actions group with 1 update:
  [python-semantic-release/python-semantic-release](https://github.com/python-semantic-release/python-semantic-release).

Updates `python-semantic-release/python-semantic-release` from 9.8.3 to 9.8.5 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
...
- Bump python-semantic-release/python-semantic-release
  ([#22](https://github.com/Nicconike/Steam-Stats/pull/22),
  [`244487e`](https://github.com/Nicconike/Steam-Stats/commit/244487e29e93757f37b7ff62d9305e936bf1080f))
...
- Bump the github-actions group with 2 updates
  ([#15](https://github.com/Nicconike/Steam-Stats/pull/15),
  [`1dfc8cb`](https://github.com/Nicconike/Steam-Stats/commit/1dfc8cb79ec89c77d349eabb9723cf5871359cf7))

Bumps the github-actions group with 2 updates:
  [python-semantic-release/python-semantic-release](https://github.com/python-semantic-release/python-semantic-release)
  and [docker/scout-action](https://github.com/docker/scout-action).

Updates `python-semantic-release/python-semantic-release` from 9.8.5 to 9.8.6 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
  [Commits](https://github.com/python-semantic-release/python-semantic-release/compare/v9.8.5...v9.8.6)

Updates `docker/scout-action` from 1.10.0 to 1.11.0 - [Release
  notes](https://github.com/docker/scout-action/releases) -
...
- dependency-name: docker/scout-action dependency-type: direct:production
...
- **deps**: Bump the python-packages group with 2 updates
  ([#9](https://github.com/Nicconike/Steam-Stats/pull/9),
  [`dc42d6b`](https://github.com/Nicconike/Steam-Stats/commit/dc42d6b3e8533901dc0cfcb2a9475ee3a20a6ef6))

Bumps the python-packages group with 2 updates:
  [playwright](https://github.com/Microsoft/playwright-python) and
  [python-semantic-release](https://github.com/python-semantic-release/python-semantic-release).

Updates `playwright` from 1.44.0 to 1.45.0 - [Release
  notes](https://github.com/Microsoft/playwright-python/releases) -
  [Commits](https://github.com/Microsoft/playwright-python/compare/v1.44.0...v1.45.0)

Updates `python-semantic-release` from 9.8.3 to 9.8.5 - [Release
  notes](https://github.com/python-semantic-release/python-semantic-release/releases) -
  [Changelog](https://github.com/python-semantic-release/python-semantic-release/blob/master/CHANGELOG.md)
  -
  [Commits](https://github.com/python-semantic-release/python-semantic-release/compare/v9.8.3...v9.8.5)
...
- **deps**: Bump pylint in the python-packages group
  ([#8](https://github.com/Nicconike/Steam-Stats/pull/8),
  [`3915a4d`](https://github.com/Nicconike/Steam-Stats/commit/3915a4df619f620282d9356e91973196b6ce70ee))

Bumps the python-packages group with 1 update: [pylint](https://github.com/pylint-dev/pylint).

Updates `pylint` from 3.2.3 to 3.2.5 - [Release
  notes](https://github.com/pylint-dev/pylint/releases) -
...
- Bump docker/scout-action from 1.9.3 to 1.10.0 in the github-actions group
  ([#5](https://github.com/Nicconike/Steam-Stats/pull/5),
  [`2a481b3`](https://github.com/Nicconike/Steam-Stats/commit/2a481b38f20e015e400d0022bedf4256e4fdf256))
...
Updates `docker/scout-action` from 1.9.3 to 1.10.0 - [Release
  notes](https://github.com/docker/scout-action/releases) -
